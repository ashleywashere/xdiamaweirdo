...
do -- ESP Functions
    function ESP:Player(Instance, Data)
        ...
        Components.Name = Framework:Draw("Text", {Text = Instance.Name, Font = Monospace, Size = 16, Outline = true, Center = true})
        Components.NameBold = Framework:Draw("Text", {Text = Instance.Name, Font = Monospace, Size = 16, Center = true})
        Components.Distance = Framework:Draw("Text", {Font = Monospace, Size = 16, Outline = true, Center = true})
        Components.DistanceBold = Framework:Draw("Text", {Font = Monospace, Size = 16, Center = true})
        Components.Tool = Framework:Draw("Text", {Font = Monospace, Size = 16, Outline = true, Center = true})
        Components.ToolBold = Framework:Draw("Text", {Font = Monospace, Size = 16, Center = true})
        Components.Health = Framework:Draw("Text", {Font = Monospace, Size = 16, Outline = true, Center = true})
        Components.HealthBold = Framework:Draw("Text", {Font = Monospace, Size = 16, Center = true})

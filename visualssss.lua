...
do -- ESP Functions
    function ESP:Player(Instance, Data)
        ...
        Components.Name = VisualKit:Draw("Text", {Text = Instance.Name, Font = Drawing.Fonts.UI, Size = 13, Outline = true, Center = true})
        Components.NameBold = VisualKit:Draw("Text", {Text = Instance.Name, Font = Drawing.Fonts.UI, Size = 13, Center = true})
        Components.Distance = VisualKit:Draw("Text", {Font = Drawing.Fonts.UI, Size = 13, Outline = true, Center = true})
        Components.DistanceBold = VisualKit:Draw("Text", {Font = Drawing.Fonts.UI, Size = 13, Center = true})
        Components.Tool = VisualKit:Draw("Text", {Font = Drawing.Fonts.UI, Size = 13, Outline = true, Center = true})
        Components.ToolBold = VisualKit:Draw("Text", {Font = Drawing.Fonts.UI, Size = 13, Center = true})
        Components.Health = VisualKit:Draw("Text", {Font = Drawing.Fonts.UI, Size = 13, Outline = true, Center = true})
        Components.HealthBold = VisualKit:Draw("Text", {Font = Drawing.Fonts.UI, Size = 13, Center = true})
